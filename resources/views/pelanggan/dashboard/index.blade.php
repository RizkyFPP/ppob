    ...
    <div class="row py-4">
      <div class="col-md-3">
        <div class="card">
          ...
          <div class="card-footer">
            <h5>
              <a href="{{ route('pelanggan-tagihan') }}" class="nav-link">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="card">
          ...
          <div class="card-footer">
            <h5>
              <a href="{{ route('riwayat-pembayaran') }}" class="nav-link">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </h5>
          </div>
        </div>
      </div>
